    ...
    <React.Fragment>
      ...
      <div className="form__row">
        <div className="form__col form__col_4">
          <div className="form__field">
            <label
              htmlFor={ `${field}.mail_address_country` }
        ...
        <div className="form__col form__col_4">
          <div className="form__field">
            <label
              htmlFor={ `${field}.mail_address_state` }
              className="form__label"
            >
              Область/Край
            </label>
        ...
        <div className="form__col form__col_4">
          <div className="form__field">
            <label
              htmlFor={ `${field}.mail_address_city` }
              className="form__label"
            >
              Город
            </label>
      ...
      <div className="form__row">
        <div className="form__col form__col_4">
          <div className="form__field">
            <label
              htmlFor={ `${field}.mail_address_street` }
              className="form__label"
            >
              Улица
            </label>
        ...
        <div className="form__col form__col_2">
          <div className="form__field">
            <label
              htmlFor={ `${field}.mail_address_house` }
              className="form__label"
            >
              Дом
            </label>
        ...
        <div className="form__col form__col_2">
          <div className="form__field">
            <label
              htmlFor={ `${field}.mail_address_housing` }
              className="form__label"
            >
              Корпус
            </label>
        ...
        <div className="form__col form__col_2">
          <div className="form__field">
            <label
              htmlFor={ `${field}.mail_address_room` }
              className="form__label"
            >
              Квартира
            </label>
        ...
        <div className="form__col form__col_2">
          <div className="form__field">
            <label
              htmlFor={ `${field}.mail_address_index` }
              className="form__label"
            >
              Индекс
            </label>
